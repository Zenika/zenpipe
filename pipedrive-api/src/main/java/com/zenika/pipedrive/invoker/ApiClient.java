package com.zenika.pipedrive.invoker;
...
import com.zenika.pipedrive.invoker.auth.HttpBasicAuth;
import com.zenika.pipedrive.invoker.auth.HttpBearerAuth;
import com.zenika.pipedrive.invoker.auth.ApiKeyAuth;
import com.zenika.pipedrive.invoker.ApiResponseDecoder;

import com.zenika.pipedrive.invoker.auth.ApiErrorDecoder;
import com.zenika.pipedrive.invoker.auth.OAuth;
import com.zenika.pipedrive.invoker.auth.OAuth.AccessTokenListener;
import com.zenika.pipedrive.invoker.auth.OAuthFlow;
import com.zenika.pipedrive.invoker.auth.OauthPasswordGrant;
import com.zenika.pipedrive.invoker.auth.OauthClientCredentialsGrant;
...
public class ApiClient {
  ...
  private String basePath = "https://api.pipedrive.com/v1";
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("api_key".equals(authName)) {
        auth = new ApiKeyAuth("query", "api_token");
      } else if ("oauth2".equals(authName)) {
        auth = buildOauthRequestInterceptor(OAuthFlow.ACCESS_CODE, "https://oauth.pipedrive.com/oauth/authorize", "https://oauth.pipedrive.com/oauth/token", "deals:read, deals:full, goals:read, goals:full, leads:read, leads:full, activities:read, activities:full, contacts:read, contacts:full, admin, recents:read, search:read, mail:read, mail:full, products:read, products:full, users:read, base, phone-integration");
      } else {

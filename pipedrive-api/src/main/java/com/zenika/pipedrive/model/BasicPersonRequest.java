 ...
 */
@JsonPropertyOrder({
  BasicPersonRequest.JSON_PROPERTY_OWNER_ID,
  BasicPersonRequest.JSON_PROPERTY_ORG_ID,
  BasicPersonRequest.JSON_PROPERTY_EMAIL,
  BasicPersonRequest.JSON_PROPERTY_PHONE,
  BasicPersonRequest.JSON_PROPERTY_VISIBLE_TO,
  BasicPersonRequest.JSON_PROPERTY_MARKETING_STATUS,
  BasicPersonRequest.JSON_PROPERTY_ADD_TIME
})
@JsonTypeName("basicPersonRequest")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-01-24T19:04:25.918485+01:00[Europe/Paris]")
public class BasicPersonRequest {
  ...
  public BasicPersonRequest() {
  }

  public BasicPersonRequest ownerId(Integer ownerId) {
  ...
  **/
  ...
  public BasicPersonRequest orgId(Integer orgId) {
  ...
  **/
  ...
  public BasicPersonRequest email(List<BasicPersonRequestEmailInner> email) {
    
    this.email = email;
    return this;
  }

  public BasicPersonRequest addEmailItem(BasicPersonRequestEmailInner emailItem) {
    if (this.email == null) {
  ...
  **/
  ...
  public BasicPersonRequest phone(List<PersonItemAllOfPhoneInner> phone) {
    
    this.phone = phone;
    return this;
  }

  public BasicPersonRequest addPhoneItem(PersonItemAllOfPhoneInner phoneItem) {
    if (this.phone == null) {
  ...
  **/
  ...
  public BasicPersonRequest visibleTo(VisibleToEnum visibleTo) {
  ...
  **/
  ...
  public BasicPersonRequest marketingStatus(MarketingStatusEnum marketingStatus) {
  ...
  **/
  ...
  public BasicPersonRequest addTime(String addTime) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BasicPersonRequest basicPersonRequest = (BasicPersonRequest) o;
    return Objects.equals(this.ownerId, basicPersonRequest.ownerId) &&
        Objects.equals(this.orgId, basicPersonRequest.orgId) &&
        Objects.equals(this.email, basicPersonRequest.email) &&
        Objects.equals(this.phone, basicPersonRequest.phone) &&
        Objects.equals(this.visibleTo, basicPersonRequest.visibleTo) &&
        Objects.equals(this.marketingStatus, basicPersonRequest.marketingStatus) &&
        Objects.equals(this.addTime, basicPersonRequest.addTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ownerId, orgId, email, phone, visibleTo, marketingStatus, addTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BasicPersonRequest {\n");

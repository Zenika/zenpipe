 ...
 */
@JsonPropertyOrder({
  MergePersonsRequest.JSON_PROPERTY_MERGE_WITH_ID
})
@JsonTypeName("mergePersonsRequest")
...
public class MergePersonsRequest {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The ID of the person that will not be overwritten. This person’s data will be prioritized in case of conflict with the other person.")
  ...
  public boolean equals(Object o) {
    ...
    MergePersonsRequest mergePersonsRequest = (MergePersonsRequest) o;
    return Objects.equals(this.mergeWithId, mergePersonsRequest.mergeWithId);
  }

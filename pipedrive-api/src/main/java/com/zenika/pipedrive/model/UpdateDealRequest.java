 ...
 */
@JsonPropertyOrder({
  UpdateDealRequest.JSON_PROPERTY_TITLE,
  UpdateDealRequest.JSON_PROPERTY_VALUE,
  UpdateDealRequest.JSON_PROPERTY_CURRENCY,
  UpdateDealRequest.JSON_PROPERTY_USER_ID,
  UpdateDealRequest.JSON_PROPERTY_PERSON_ID,
  UpdateDealRequest.JSON_PROPERTY_ORG_ID,
  UpdateDealRequest.JSON_PROPERTY_PIPELINE_ID,
  UpdateDealRequest.JSON_PROPERTY_STAGE_ID,
  UpdateDealRequest.JSON_PROPERTY_STATUS,
  UpdateDealRequest.JSON_PROPERTY_EXPECTED_CLOSE_DATE,
  UpdateDealRequest.JSON_PROPERTY_PROBABILITY,
  UpdateDealRequest.JSON_PROPERTY_LOST_REASON,
  UpdateDealRequest.JSON_PROPERTY_VISIBLE_TO
})
@JsonTypeName("updateDealRequest")
...
public class UpdateDealRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, updateDealRequest.title) &&
        Objects.equals(this.value, updateDealRequest.value) &&
        Objects.equals(this.currency, updateDealRequest.currency) &&
        Objects.equals(this.userId, updateDealRequest.userId) &&
        Objects.equals(this.personId, updateDealRequest.personId) &&
        Objects.equals(this.orgId, updateDealRequest.orgId) &&
        Objects.equals(this.pipelineId, updateDealRequest.pipelineId) &&
        Objects.equals(this.stageId, updateDealRequest.stageId) &&
        Objects.equals(this.status, updateDealRequest.status) &&
        Objects.equals(this.expectedCloseDate, updateDealRequest.expectedCloseDate) &&
        Objects.equals(this.probability, updateDealRequest.probability) &&
        Objects.equals(this.lostReason, updateDealRequest.lostReason) &&
        Objects.equals(this.visibleTo, updateDealRequest.visibleTo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, value, currency, userId, personId, orgId, pipelineId, stageId, status, expectedCloseDate, probability, lostReason, visibleTo);
  }

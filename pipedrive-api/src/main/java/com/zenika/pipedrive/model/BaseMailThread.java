 ...
 */
@JsonPropertyOrder({
  BaseMailThread.JSON_PROPERTY_ID,
  BaseMailThread.JSON_PROPERTY_ACCOUNT_ID,
  BaseMailThread.JSON_PROPERTY_USER_ID,
  BaseMailThread.JSON_PROPERTY_SUBJECT,
  BaseMailThread.JSON_PROPERTY_SNIPPET,
  BaseMailThread.JSON_PROPERTY_READ_FLAG,
  BaseMailThread.JSON_PROPERTY_MAIL_TRACKING_STATUS,
  BaseMailThread.JSON_PROPERTY_HAS_ATTACHMENTS_FLAG,
  BaseMailThread.JSON_PROPERTY_HAS_INLINE_ATTACHMENTS_FLAG,
  BaseMailThread.JSON_PROPERTY_HAS_REAL_ATTACHMENTS_FLAG,
  BaseMailThread.JSON_PROPERTY_DELETED_FLAG,
  BaseMailThread.JSON_PROPERTY_SYNCED_FLAG,
  BaseMailThread.JSON_PROPERTY_SMART_BCC_FLAG,
  BaseMailThread.JSON_PROPERTY_MAIL_LINK_TRACKING_ENABLED_FLAG,
  BaseMailThread.JSON_PROPERTY_PARTIES,
  BaseMailThread.JSON_PROPERTY_DRAFTS_PARTIES,
  BaseMailThread.JSON_PROPERTY_FOLDERS,
  BaseMailThread.JSON_PROPERTY_VERSION,
  BaseMailThread.JSON_PROPERTY_SNIPPET_DRAFT,
  BaseMailThread.JSON_PROPERTY_SNIPPET_SENT,
  BaseMailThread.JSON_PROPERTY_MESSAGE_COUNT,
  BaseMailThread.JSON_PROPERTY_HAS_DRAFT_FLAG,
  BaseMailThread.JSON_PROPERTY_HAS_SENT_FLAG,
  BaseMailThread.JSON_PROPERTY_ARCHIVED_FLAG,
  BaseMailThread.JSON_PROPERTY_SHARED_FLAG,
  BaseMailThread.JSON_PROPERTY_EXTERNAL_DELETED_FLAG,
  BaseMailThread.JSON_PROPERTY_FIRST_MESSAGE_TO_ME_FLAG,
  BaseMailThread.JSON_PROPERTY_LAST_MESSAGE_TIMESTAMP,
  BaseMailThread.JSON_PROPERTY_FIRST_MESSAGE_TIMESTAMP,
  BaseMailThread.JSON_PROPERTY_LAST_MESSAGE_SENT_TIMESTAMP,
  BaseMailThread.JSON_PROPERTY_LAST_MESSAGE_RECEIVED_TIMESTAMP,
  BaseMailThread.JSON_PROPERTY_ADD_TIME,
  BaseMailThread.JSON_PROPERTY_UPDATE_TIME,
  BaseMailThread.JSON_PROPERTY_DEAL_ID,
  BaseMailThread.JSON_PROPERTY_DEAL_STATUS,
  BaseMailThread.JSON_PROPERTY_LEAD_ID,
  BaseMailThread.JSON_PROPERTY_ALL_MESSAGES_SENT_FLAG
})
@JsonTypeName("baseMailThread")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-01-24T19:04:25.918485+01:00[Europe/Paris]")
public class BaseMailThread {
  ...
  public BaseMailThread() {
  }

  public BaseMailThread id(Integer id) {
  ...
  **/
  ...
  public BaseMailThread accountId(String accountId) {
  ...
  **/
  ...
  public BaseMailThread userId(Integer userId) {
  ...
  **/
  ...
  public BaseMailThread subject(String subject) {
  ...
  **/
  ...
  public BaseMailThread snippet(String snippet) {
  ...
  **/
  ...
  public BaseMailThread readFlag(ReadFlagEnum readFlag) {
  ...
  **/
  ...
  public BaseMailThread mailTrackingStatus(String mailTrackingStatus) {
  ...
  **/
  ...
  public BaseMailThread hasAttachmentsFlag(HasAttachmentsFlagEnum hasAttachmentsFlag) {
  ...
  **/
  ...
  public BaseMailThread hasInlineAttachmentsFlag(HasInlineAttachmentsFlagEnum hasInlineAttachmentsFlag) {
  ...
  **/
  ...
  public BaseMailThread hasRealAttachmentsFlag(HasRealAttachmentsFlagEnum hasRealAttachmentsFlag) {
  ...
  **/
  ...
  public BaseMailThread deletedFlag(DeletedFlagEnum deletedFlag) {
  ...
  **/
  ...
  public BaseMailThread syncedFlag(SyncedFlagEnum syncedFlag) {
  ...
  **/
  ...
  public BaseMailThread smartBccFlag(SmartBccFlagEnum smartBccFlag) {
  ...
  **/
  ...
  public BaseMailThread mailLinkTrackingEnabledFlag(MailLinkTrackingEnabledFlagEnum mailLinkTrackingEnabledFlag) {
  ...
  **/
  ...
  public BaseMailThread parties(BaseMailThreadAllOf1Parties parties) {
  ...
  **/
  ...
  public BaseMailThread draftsParties(List<Object> draftsParties) {
    
    this.draftsParties = draftsParties;
    return this;
  }

  public BaseMailThread addDraftsPartiesItem(Object draftsPartiesItem) {
  ...
  **/
  ...
  public BaseMailThread folders(List<String> folders) {
    
    this.folders = folders;
    return this;
  }

  public BaseMailThread addFoldersItem(String foldersItem) {
  ...
  **/
  ...
  public BaseMailThread version(BigDecimal version) {
  ...
  **/
  ...
  public BaseMailThread snippetDraft(String snippetDraft) {
  ...
  **/
  ...
  public BaseMailThread snippetSent(String snippetSent) {
  ...
  **/
  ...
  public BaseMailThread messageCount(Integer messageCount) {
  ...
  **/
  ...
  public BaseMailThread hasDraftFlag(HasDraftFlagEnum hasDraftFlag) {
  ...
  **/
  ...
  public BaseMailThread hasSentFlag(HasSentFlagEnum hasSentFlag) {
  ...
  **/
  ...
  public BaseMailThread archivedFlag(ArchivedFlagEnum archivedFlag) {
  ...
  **/
  ...
  public BaseMailThread sharedFlag(SharedFlagEnum sharedFlag) {
  ...
  **/
  ...
  public BaseMailThread externalDeletedFlag(ExternalDeletedFlagEnum externalDeletedFlag) {
  ...
  **/
  ...
  public BaseMailThread firstMessageToMeFlag(FirstMessageToMeFlagEnum firstMessageToMeFlag) {
  ...
  **/
  ...
  public BaseMailThread lastMessageTimestamp(OffsetDateTime lastMessageTimestamp) {
  ...
  **/
  ...
  public BaseMailThread firstMessageTimestamp(OffsetDateTime firstMessageTimestamp) {
  ...
  **/
  ...
  public BaseMailThread lastMessageSentTimestamp(OffsetDateTime lastMessageSentTimestamp) {
  ...
  **/
  ...
  public BaseMailThread lastMessageReceivedTimestamp(OffsetDateTime lastMessageReceivedTimestamp) {
  ...
  **/
  ...
  public BaseMailThread addTime(OffsetDateTime addTime) {
  ...
  **/
  ...
  public BaseMailThread updateTime(OffsetDateTime updateTime) {
  ...
  **/
  ...
  public BaseMailThread dealId(Integer dealId) {
  ...
  **/
  ...
  public BaseMailThread dealStatus(String dealStatus) {
  ...
  **/
  ...
  public BaseMailThread leadId(UUID leadId) {
  ...
  **/
  ...
  public BaseMailThread allMessagesSentFlag(AllMessagesSentFlagEnum allMessagesSentFlag) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BaseMailThread baseMailThread = (BaseMailThread) o;
    return Objects.equals(this.id, baseMailThread.id) &&
        Objects.equals(this.accountId, baseMailThread.accountId) &&
        Objects.equals(this.userId, baseMailThread.userId) &&
        Objects.equals(this.subject, baseMailThread.subject) &&
        Objects.equals(this.snippet, baseMailThread.snippet) &&
        Objects.equals(this.readFlag, baseMailThread.readFlag) &&
        equalsNullable(this.mailTrackingStatus, baseMailThread.mailTrackingStatus) &&
        Objects.equals(this.hasAttachmentsFlag, baseMailThread.hasAttachmentsFlag) &&
        Objects.equals(this.hasInlineAttachmentsFlag, baseMailThread.hasInlineAttachmentsFlag) &&
        Objects.equals(this.hasRealAttachmentsFlag, baseMailThread.hasRealAttachmentsFlag) &&
        Objects.equals(this.deletedFlag, baseMailThread.deletedFlag) &&
        Objects.equals(this.syncedFlag, baseMailThread.syncedFlag) &&
        Objects.equals(this.smartBccFlag, baseMailThread.smartBccFlag) &&
        Objects.equals(this.mailLinkTrackingEnabledFlag, baseMailThread.mailLinkTrackingEnabledFlag) &&
        Objects.equals(this.parties, baseMailThread.parties) &&
        Objects.equals(this.draftsParties, baseMailThread.draftsParties) &&
        Objects.equals(this.folders, baseMailThread.folders) &&
        Objects.equals(this.version, baseMailThread.version) &&
        equalsNullable(this.snippetDraft, baseMailThread.snippetDraft) &&
        Objects.equals(this.snippetSent, baseMailThread.snippetSent) &&
        Objects.equals(this.messageCount, baseMailThread.messageCount) &&
        Objects.equals(this.hasDraftFlag, baseMailThread.hasDraftFlag) &&
        Objects.equals(this.hasSentFlag, baseMailThread.hasSentFlag) &&
        Objects.equals(this.archivedFlag, baseMailThread.archivedFlag) &&
        Objects.equals(this.sharedFlag, baseMailThread.sharedFlag) &&
        Objects.equals(this.externalDeletedFlag, baseMailThread.externalDeletedFlag) &&
        Objects.equals(this.firstMessageToMeFlag, baseMailThread.firstMessageToMeFlag) &&
        Objects.equals(this.lastMessageTimestamp, baseMailThread.lastMessageTimestamp) &&
        Objects.equals(this.firstMessageTimestamp, baseMailThread.firstMessageTimestamp) &&
        equalsNullable(this.lastMessageSentTimestamp, baseMailThread.lastMessageSentTimestamp) &&
        Objects.equals(this.lastMessageReceivedTimestamp, baseMailThread.lastMessageReceivedTimestamp) &&
        Objects.equals(this.addTime, baseMailThread.addTime) &&
        Objects.equals(this.updateTime, baseMailThread.updateTime) &&
        equalsNullable(this.dealId, baseMailThread.dealId) &&
        equalsNullable(this.dealStatus, baseMailThread.dealStatus) &&
        equalsNullable(this.leadId, baseMailThread.leadId) &&
        Objects.equals(this.allMessagesSentFlag, baseMailThread.allMessagesSentFlag);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseMailThread {\n");

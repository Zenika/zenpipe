 ...
 */
@JsonPropertyOrder({
  AddProductRequest1.JSON_PROPERTY_NAME,
  AddProductRequest1.JSON_PROPERTY_CODE,
  AddProductRequest1.JSON_PROPERTY_UNIT,
  AddProductRequest1.JSON_PROPERTY_TAX,
  AddProductRequest1.JSON_PROPERTY_ACTIVE_FLAG,
  AddProductRequest1.JSON_PROPERTY_SELECTABLE,
  AddProductRequest1.JSON_PROPERTY_VISIBLE_TO,
  AddProductRequest1.JSON_PROPERTY_OWNER_ID,
  AddProductRequest1.JSON_PROPERTY_PRICES
})
@JsonTypeName("addProductRequest_1")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-01-24T19:04:25.918485+01:00[Europe/Paris]")
public class AddProductRequest1 {
  ...
  public AddProductRequest1 name(String name) {
  ...
  **/
  ...
  public AddProductRequest1 code(String code) {
  ...
  **/
  ...
  public AddProductRequest1 unit(String unit) {
  ...
  **/
  ...
  public AddProductRequest1 tax(BigDecimal tax) {
  ...
  **/
  ...
  public AddProductRequest1 activeFlag(ActiveFlagEnum activeFlag) {
  ...
  **/
  ...
  public AddProductRequest1 selectable(SelectableEnum selectable) {
  ...
  **/
  ...
  public AddProductRequest1 visibleTo(VisibleToEnum visibleTo) {
  ...
  **/
  ...
  public AddProductRequest1 ownerId(Integer ownerId) {
  ...
  **/
  ...
  public AddProductRequest1 prices(List<Object> prices) {
    
    this.prices = prices;
    return this;
  }

  public AddProductRequest1 addPricesItem(Object pricesItem) {
    if (this.prices == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddProductRequest1 addProductRequest1 = (AddProductRequest1) o;
    return Objects.equals(this.name, addProductRequest1.name) &&
        Objects.equals(this.code, addProductRequest1.code) &&
        Objects.equals(this.unit, addProductRequest1.unit) &&
        Objects.equals(this.tax, addProductRequest1.tax) &&
        Objects.equals(this.activeFlag, addProductRequest1.activeFlag) &&
        Objects.equals(this.selectable, addProductRequest1.selectable) &&
        Objects.equals(this.visibleTo, addProductRequest1.visibleTo) &&
        Objects.equals(this.ownerId, addProductRequest1.ownerId) &&
        Objects.equals(this.prices, addProductRequest1.prices);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, code, unit, tax, activeFlag, selectable, visibleTo, ownerId, prices);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddProductRequest1 {\n");

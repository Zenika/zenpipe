 ...
 */
@JsonPropertyOrder({
  PersonItemAllOfPictureId.JSON_PROPERTY_ID,
  PersonItemAllOfPictureId.JSON_PROPERTY_ITEM_TYPE,
  PersonItemAllOfPictureId.JSON_PROPERTY_ITEM_ID,
  PersonItemAllOfPictureId.JSON_PROPERTY_ACTIVE_FLAG,
  PersonItemAllOfPictureId.JSON_PROPERTY_ADD_TIME,
  PersonItemAllOfPictureId.JSON_PROPERTY_UPDATE_TIME,
  PersonItemAllOfPictureId.JSON_PROPERTY_ADDED_BY_USER_ID,
  PersonItemAllOfPictureId.JSON_PROPERTY_PICTURES
})
@JsonTypeName("personItem_allOf_picture_id")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-01-24T19:04:25.918485+01:00[Europe/Paris]")
public class PersonItemAllOfPictureId {
  ...
  public PersonItemAllOfPictureId() {
  }

  public PersonItemAllOfPictureId id(Integer id) {
  ...
  **/
  ...
  public PersonItemAllOfPictureId itemType(String itemType) {
  ...
  **/
  ...
  public PersonItemAllOfPictureId itemId(Integer itemId) {
  ...
  **/
  ...
  public PersonItemAllOfPictureId activeFlag(Boolean activeFlag) {
  ...
  **/
  ...
  public PersonItemAllOfPictureId addTime(String addTime) {
  ...
  **/
  ...
  public PersonItemAllOfPictureId updateTime(String updateTime) {
  ...
  **/
  ...
  public PersonItemAllOfPictureId addedByUserId(Integer addedByUserId) {
  ...
  **/
  ...
  public PersonItemAllOfPictureId pictures(PersonItemAllOfPictureIdAllOf1Pictures pictures) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonItemAllOfPictureId personItemAllOfPictureId = (PersonItemAllOfPictureId) o;
    return Objects.equals(this.id, personItemAllOfPictureId.id) &&
        Objects.equals(this.itemType, personItemAllOfPictureId.itemType) &&
        Objects.equals(this.itemId, personItemAllOfPictureId.itemId) &&
        Objects.equals(this.activeFlag, personItemAllOfPictureId.activeFlag) &&
        Objects.equals(this.addTime, personItemAllOfPictureId.addTime) &&
        Objects.equals(this.updateTime, personItemAllOfPictureId.updateTime) &&
        Objects.equals(this.addedByUserId, personItemAllOfPictureId.addedByUserId) &&
        Objects.equals(this.pictures, personItemAllOfPictureId.pictures);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonItemAllOfPictureId {\n");

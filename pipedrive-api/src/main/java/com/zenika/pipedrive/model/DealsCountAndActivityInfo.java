 ...
 */
@JsonPropertyOrder({
  DealsCountAndActivityInfo.JSON_PROPERTY_OPEN_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_RELATED_OPEN_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_CLOSED_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_RELATED_CLOSED_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_WON_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_RELATED_WON_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_LOST_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_RELATED_LOST_DEALS_COUNT,
  DealsCountAndActivityInfo.JSON_PROPERTY_NEXT_ACTIVITY_DATE,
  DealsCountAndActivityInfo.JSON_PROPERTY_NEXT_ACTIVITY_TIME,
  DealsCountAndActivityInfo.JSON_PROPERTY_NEXT_ACTIVITY_ID,
  DealsCountAndActivityInfo.JSON_PROPERTY_LAST_ACTIVITY_ID,
  DealsCountAndActivityInfo.JSON_PROPERTY_LAST_ACTIVITY_DATE
})
@JsonTypeName("dealsCountAndActivityInfo")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-01-24T19:04:25.918485+01:00[Europe/Paris]")
public class DealsCountAndActivityInfo {
  ...
  public DealsCountAndActivityInfo() {
  }

  public DealsCountAndActivityInfo openDealsCount(Integer openDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo relatedOpenDealsCount(Integer relatedOpenDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo closedDealsCount(Integer closedDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo relatedClosedDealsCount(Integer relatedClosedDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo wonDealsCount(Integer wonDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo relatedWonDealsCount(Integer relatedWonDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo lostDealsCount(Integer lostDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo relatedLostDealsCount(Integer relatedLostDealsCount) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo nextActivityDate(String nextActivityDate) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo nextActivityTime(String nextActivityTime) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo nextActivityId(Integer nextActivityId) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo lastActivityId(Integer lastActivityId) {
  ...
  **/
  ...
  public DealsCountAndActivityInfo lastActivityDate(String lastActivityDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DealsCountAndActivityInfo dealsCountAndActivityInfo = (DealsCountAndActivityInfo) o;
    return Objects.equals(this.openDealsCount, dealsCountAndActivityInfo.openDealsCount) &&
        Objects.equals(this.relatedOpenDealsCount, dealsCountAndActivityInfo.relatedOpenDealsCount) &&
        Objects.equals(this.closedDealsCount, dealsCountAndActivityInfo.closedDealsCount) &&
        Objects.equals(this.relatedClosedDealsCount, dealsCountAndActivityInfo.relatedClosedDealsCount) &&
        Objects.equals(this.wonDealsCount, dealsCountAndActivityInfo.wonDealsCount) &&
        Objects.equals(this.relatedWonDealsCount, dealsCountAndActivityInfo.relatedWonDealsCount) &&
        Objects.equals(this.lostDealsCount, dealsCountAndActivityInfo.lostDealsCount) &&
        Objects.equals(this.relatedLostDealsCount, dealsCountAndActivityInfo.relatedLostDealsCount) &&
        Objects.equals(this.nextActivityDate, dealsCountAndActivityInfo.nextActivityDate) &&
        Objects.equals(this.nextActivityTime, dealsCountAndActivityInfo.nextActivityTime) &&
        equalsNullable(this.nextActivityId, dealsCountAndActivityInfo.nextActivityId) &&
        equalsNullable(this.lastActivityId, dealsCountAndActivityInfo.lastActivityId) &&
        equalsNullable(this.lastActivityDate, dealsCountAndActivityInfo.lastActivityDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class DealsCountAndActivityInfo {\n");

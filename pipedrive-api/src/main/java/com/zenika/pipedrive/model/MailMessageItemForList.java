 ...
 */
@JsonPropertyOrder({
  MailMessageItemForList.JSON_PROPERTY_ID,
  MailMessageItemForList.JSON_PROPERTY_FROM,
  MailMessageItemForList.JSON_PROPERTY_TO,
  MailMessageItemForList.JSON_PROPERTY_CC,
  MailMessageItemForList.JSON_PROPERTY_BCC,
  MailMessageItemForList.JSON_PROPERTY_BODY_URL,
  MailMessageItemForList.JSON_PROPERTY_ACCOUNT_ID,
  MailMessageItemForList.JSON_PROPERTY_USER_ID,
  MailMessageItemForList.JSON_PROPERTY_MAIL_THREAD_ID,
  MailMessageItemForList.JSON_PROPERTY_SUBJECT,
  MailMessageItemForList.JSON_PROPERTY_SNIPPET,
  MailMessageItemForList.JSON_PROPERTY_MAIL_TRACKING_STATUS,
  MailMessageItemForList.JSON_PROPERTY_MAIL_LINK_TRACKING_ENABLED_FLAG,
  MailMessageItemForList.JSON_PROPERTY_READ_FLAG,
  MailMessageItemForList.JSON_PROPERTY_DRAFT,
  MailMessageItemForList.JSON_PROPERTY_DRAFT_FLAG,
  MailMessageItemForList.JSON_PROPERTY_SYNCED_FLAG,
  MailMessageItemForList.JSON_PROPERTY_DELETED_FLAG,
  MailMessageItemForList.JSON_PROPERTY_HAS_BODY_FLAG,
  MailMessageItemForList.JSON_PROPERTY_SENT_FLAG,
  MailMessageItemForList.JSON_PROPERTY_SENT_FROM_PIPEDRIVE_FLAG,
  MailMessageItemForList.JSON_PROPERTY_SMART_BCC_FLAG,
  MailMessageItemForList.JSON_PROPERTY_MESSAGE_TIME,
  MailMessageItemForList.JSON_PROPERTY_ADD_TIME,
  MailMessageItemForList.JSON_PROPERTY_UPDATE_TIME,
  MailMessageItemForList.JSON_PROPERTY_HAS_ATTACHMENTS_FLAG,
  MailMessageItemForList.JSON_PROPERTY_HAS_INLINE_ATTACHMENTS_FLAG,
  MailMessageItemForList.JSON_PROPERTY_HAS_REAL_ATTACHMENTS_FLAG,
  MailMessageItemForList.JSON_PROPERTY_NYLAS_ID,
  MailMessageItemForList.JSON_PROPERTY_S3_BUCKET,
  MailMessageItemForList.JSON_PROPERTY_S3_BUCKET_PATH,
  MailMessageItemForList.JSON_PROPERTY_EXTERNAL_DELETED_FLAG,
  MailMessageItemForList.JSON_PROPERTY_MUA_MESSAGE_ID,
  MailMessageItemForList.JSON_PROPERTY_TEMPLATE_ID,
  MailMessageItemForList.JSON_PROPERTY_TIMESTAMP,
  MailMessageItemForList.JSON_PROPERTY_ITEM_TYPE,
  MailMessageItemForList.JSON_PROPERTY_COMPANY_ID
})
@JsonTypeName("mailMessageItemForList")
...
public class MailMessageItemForList {
  ...
  **/
  ...
  public MailMessageItemForList from(List<MailMessageItemForListAllOfFromInner> from) {
    
    this.from = from;
    return this;
  }

  public MailMessageItemForList addFromItem(MailMessageItemForListAllOfFromInner fromItem) {
    if (this.from == null) {
  ...
  **/
  ...
  public MailMessageItemForList to(List<MailMessageItemForListAllOfFromInner> to) {
    
    this.to = to;
    return this;
  }

  public MailMessageItemForList addToItem(MailMessageItemForListAllOfFromInner toItem) {
    if (this.to == null) {
  ...
  **/
  ...
  public MailMessageItemForList cc(List<MailMessageItemForListAllOfFromInner> cc) {
    
    this.cc = cc;
    return this;
  }

  public MailMessageItemForList addCcItem(MailMessageItemForListAllOfFromInner ccItem) {
    if (this.cc == null) {
  ...
  **/
  ...
  public MailMessageItemForList bcc(List<MailMessageItemForListAllOfFromInner> bcc) {
    
    this.bcc = bcc;
    return this;
  }

  public MailMessageItemForList addBccItem(MailMessageItemForListAllOfFromInner bccItem) {
    if (this.bcc == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MailMessageItemForList mailMessageItemForList = (MailMessageItemForList) o;
    return Objects.equals(this.id, mailMessageItemForList.id) &&
        Objects.equals(this.from, mailMessageItemForList.from) &&
        Objects.equals(this.to, mailMessageItemForList.to) &&
        Objects.equals(this.cc, mailMessageItemForList.cc) &&
        Objects.equals(this.bcc, mailMessageItemForList.bcc) &&
        Objects.equals(this.bodyUrl, mailMessageItemForList.bodyUrl) &&
        Objects.equals(this.accountId, mailMessageItemForList.accountId) &&
        Objects.equals(this.userId, mailMessageItemForList.userId) &&
        Objects.equals(this.mailThreadId, mailMessageItemForList.mailThreadId) &&
        Objects.equals(this.subject, mailMessageItemForList.subject) &&
        Objects.equals(this.snippet, mailMessageItemForList.snippet) &&
        equalsNullable(this.mailTrackingStatus, mailMessageItemForList.mailTrackingStatus) &&
        Objects.equals(this.mailLinkTrackingEnabledFlag, mailMessageItemForList.mailLinkTrackingEnabledFlag) &&
        Objects.equals(this.readFlag, mailMessageItemForList.readFlag) &&
        Objects.equals(this.draft, mailMessageItemForList.draft) &&
        Objects.equals(this.draftFlag, mailMessageItemForList.draftFlag) &&
        Objects.equals(this.syncedFlag, mailMessageItemForList.syncedFlag) &&
        Objects.equals(this.deletedFlag, mailMessageItemForList.deletedFlag) &&
        Objects.equals(this.hasBodyFlag, mailMessageItemForList.hasBodyFlag) &&
        Objects.equals(this.sentFlag, mailMessageItemForList.sentFlag) &&
        Objects.equals(this.sentFromPipedriveFlag, mailMessageItemForList.sentFromPipedriveFlag) &&
        Objects.equals(this.smartBccFlag, mailMessageItemForList.smartBccFlag) &&
        Objects.equals(this.messageTime, mailMessageItemForList.messageTime) &&
        Objects.equals(this.addTime, mailMessageItemForList.addTime) &&
        Objects.equals(this.updateTime, mailMessageItemForList.updateTime) &&
        Objects.equals(this.hasAttachmentsFlag, mailMessageItemForList.hasAttachmentsFlag) &&
        Objects.equals(this.hasInlineAttachmentsFlag, mailMessageItemForList.hasInlineAttachmentsFlag) &&
        Objects.equals(this.hasRealAttachmentsFlag, mailMessageItemForList.hasRealAttachmentsFlag) &&
        Objects.equals(this.nylasId, mailMessageItemForList.nylasId) &&
        Objects.equals(this.s3Bucket, mailMessageItemForList.s3Bucket) &&
        Objects.equals(this.s3BucketPath, mailMessageItemForList.s3BucketPath) &&
        Objects.equals(this.externalDeletedFlag, mailMessageItemForList.externalDeletedFlag) &&
        Objects.equals(this.muaMessageId, mailMessageItemForList.muaMessageId) &&
        Objects.equals(this.templateId, mailMessageItemForList.templateId) &&
        Objects.equals(this.timestamp, mailMessageItemForList.timestamp) &&
        Objects.equals(this.itemType, mailMessageItemForList.itemType) &&
        Objects.equals(this.companyId, mailMessageItemForList.companyId);
  }
